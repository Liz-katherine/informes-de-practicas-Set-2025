// --- PRODUCTOS ---
const productos = [
  { id: 1, nombre: "Arroz de leche", precio: 25.0, imagen: "imagenes/Arrozdeleche.jpg", badge: "NOVEDAD", descripcionCorta: "Cremoso postre con canela.", descripcionLarga: "Cremoso, suave y con el toque justo de canela.",porciones: "Individual"  },
  { id: 2, nombre: "Merengón", precio: 45.0, imagen: "imagenes/Merengon.jpg", badge: "EXCLUSIVO GUIPUZCOA", descripcionCorta: "Merengue con nata y fruta fresca.", descripcionLarga: "Base de merengue artesanal con nata y fruta fresca.",porciones: "10 a 12 porciones"  },
  { id: 3, nombre: "Macarrones", precio: 25.50, imagen: "imagenes/macarrones.jpg", badge: "PEDIDO POR ENCARGO", descripcionCorta: "Galletas de almendra con relleno cremoso.", descripcionLarga: "Dos galletas de almendra unidas por relleno cremoso.",porciones: "6 o 12 unidades"  },
  { id: 4, nombre: "Oblea", precio: 7.50, imagen: "imagenes/oblea.jpg", badge: "SOLO EN TIENDA FISICA", descripcionCorta: "Crujientes obleas rellenas de dulce.", descripcionLarga: "Obleas delgadas y crujientes rellenas con arequipe o chocolate." , porciones: "Individual" },
  { id: 5, nombre: "Isla flotante", precio: 12.50, imagen: "imagenes/islaflotante.jpg", badge: "NOVEDAD", descripcionCorta: "Merengue sobre crema inglesa suave.", descripcionLarga: "Delicioso merengue flotando en una suave crema inglesa",porciones: "Individual"  },
  { id: 6, nombre: "Cuajada", precio: 10.50, imagen: "imagenes/cuajada.jpg", badge: "NOVEDAD", descripcionCorta: "Queso fresco con melao de panela.", descripcionLarga: "Delicioso queso fresco bañado con sipore o melao elaborado con panela",porciones: "Individual" }
];
